...
resource "google_compute_instance" "ml_demo_parent" {
  ...
  metadata_startup_script = templatefile("scripts/startup-ml-demo.sh", {
    ...
    KHULNASOFT_FORK: "khulnasoft/khulnasoft",
    KHULNASOFT_BRANCH: "master",
    KHULNASOFT_PARENT_NAME : "ml-demo-parent",
    KHULNASOFT_HOST_NAME : "ml-demo-parent",
    KHULNASOFT_CLOUD_URL : "https://app.khulnasoft.cloud",
    KHULNASOFT_CLOUD_TOKEN : "XXX",
    KHULNASOFT_CLOUD_ROOMS : "XXX",
...
resource "google_compute_instance" "ml_demo_ml_enabled" {
  ...
  metadata_startup_script = templatefile("scripts/startup-ml-demo.sh", {
    ...
    KHULNASOFT_BRANCH: "master",
    KHULNASOFT_PARENT_NAME : "ml-demo-parent",
    KHULNASOFT_HOST_NAME : "ml-demo-ml-enabled",
    KHULNASOFT_CLOUD_URL : "https://app.khulnasoft.cloud",
    KHULNASOFT_CLOUD_TOKEN : "XXX",
    KHULNASOFT_CLOUD_ROOMS : "XXX",
    RUN_THIS_LAST : file("scripts/finish-ml-demo.sh"),
...
resource "google_compute_instance" "ml_demo_ml_disabled" {
  ...
  metadata_startup_script = templatefile("scripts/startup-ml-demo.sh", {
    ...
    KHULNASOFT_BRANCH: "master",
    KHULNASOFT_PARENT_NAME : "ml-demo-parent",
    KHULNASOFT_HOST_NAME : "ml-demo-ml-disabled",
    KHULNASOFT_CLOUD_URL : "https://app.khulnasoft.cloud",
    KHULNASOFT_CLOUD_TOKEN : "XXX",
    KHULNASOFT_CLOUD_ROOMS : "XXX",
    RUN_THIS_LAST : file("scripts/finish-ml-demo.sh"),
...
resource "google_compute_instance" "ml_demo_ml_enabled_orphan" {
  ...
  metadata_startup_script = templatefile("scripts/startup-ml-demo.sh", {
    ...
    KHULNASOFT_FORK: "khulnasoft/khulnasoft",
    KHULNASOFT_BRANCH: "master",
    KHULNASOFT_PARENT_NAME : "",
    KHULNASOFT_HOST_NAME : "ml-demo-ml-enabled-orphan",
    KHULNASOFT_CLOUD_URL : "https://app.khulnasoft.cloud",
    KHULNASOFT_CLOUD_TOKEN : "XXX",
    KHULNASOFT_CLOUD_ROOMS : "XXX",
    RUN_THIS_LAST : file("scripts/finish-ml-demo.sh"),
...
resource "google_compute_instance" "ml_demo_ml_disabled_orphan" {
  ...
  metadata_startup_script = templatefile("scripts/startup-ml-demo.sh", {
    ...
    KHULNASOFT_BRANCH: "master",
    KHULNASOFT_PARENT_NAME : "",
    KHULNASOFT_HOST_NAME : "ml-demo-ml-disabled-orphan",
    KHULNASOFT_CLOUD_URL : "https://app.khulnasoft.cloud",
    KHULNASOFT_CLOUD_TOKEN : "XXX",
    KHULNASOFT_CLOUD_ROOMS : "XXX",
    RUN_THIS_LAST : file("scripts/finish-ml-demo.sh"),
...
resource "google_compute_instance" "ml_demo_ml_enabled_meetup" {
  ...
  metadata_startup_script = templatefile("scripts/startup-ml-demo.sh", {
    ...
    KHULNASOFT_BRANCH: "master",
    KHULNASOFT_PARENT_NAME : "ml-demo-parent",
    KHULNASOFT_HOST_NAME : "ml-demo-ml-enabled-meetup",
    KHULNASOFT_CLOUD_URL : "https://app.khulnasoft.cloud",
    KHULNASOFT_CLOUD_TOKEN : "XXX",
    KHULNASOFT_CLOUD_ROOMS : "XXX",
    RUN_THIS_LAST : file("scripts/finish-ml-demo.sh"),
