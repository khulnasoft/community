...
[khulnasoft-pandas](https://github.com/khulnasoft/khulnasoft-pandas/tree/master/) is a Python package that can be used to pull data from you Khulnasoft nodes into a [Pandas](https://pandas.pydata.org/pandas-docs/stable/index.html) DataFrame beloved by all.

## Contents

In this directory there are a number of sample [Jupyter](https://jupyter.org/) notebooks showing some usage of the khulnasoft-pandas package.

- [anomalies_collector_deepdive.ipynb](anomalies_collector_deepdive.ipynb): A deepdive tutorial that goes under the hood a bit on whats going on in the Khulnasoft [anomalies collector](https://github.com/andrewm4894/khulnasoft/tree/anomalies-collector/collectors/python.d.plugin/anomalies) (view on nbviewer [here](https://nbviewer.jupyter.org/github/khulnasoft/community/blob/main/khulnasoft-agent-api/khulnasoft-pandas/anomalies_collector_deepdive.ipynb)).
- [anomaly_detection.ipynb](anomaly_detection.ipynb): A notebook that pulls some recent data from a specific node and runs it though various anomaly detection algorithms using the awesome [ADTK](https://adtk.readthedocs.io/en/stable/index.html) library (view on nbviewer [here](https://nbviewer.jupyter.org/github/khulnasoft/community/blob/main/khulnasoft-agent-api/khulnasoft-pandas/anomaly_detection.ipynb)).
