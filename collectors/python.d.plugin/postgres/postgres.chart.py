# -*- coding: utf-8 -*-
# Description: example khulnasoft python.d module
...
CHARTS = {
    ...
    'backend_usage': {
        'options': [None, '% of Connections in use', 'percentage', 'backend processes', 'postgres.backend_usage',
                    'stacked'],
        'lines': [
    ...
    'forced_autovacuum': {
        'options': [None, 'Percent towards forced autovacuum', 'percent', 'autovacuum', 'postgres.forced_autovacuum',
                    'line'],
        'lines': [
    ...
    'tx_wraparound_oldest_current_xid': {
        'options': [None, 'Oldest current XID', 'xid', 'tx_wraparound', 'postgres.tx_wraparound_oldest_current_xid',
                    'line'],
        'lines': [
    ...
    'tx_wraparound_percent_towards_wraparound': {
        'options': [None, 'Percent towards wraparound', 'percent', 'tx_wraparound',
                    'postgres.percent_towards_wraparound', 'line'],
        'lines': [
