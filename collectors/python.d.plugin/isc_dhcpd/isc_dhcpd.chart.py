# -*- coding: utf-8 -*-
# Description: isc dhcpd lease khulnasoft python.d module
# Author: ilyam8
...
class Service(SimpleService):
    ...
    def check(self):
        ...
        if not self.dhcpd_leases.is_valid():
            self.error("Make sure '{path}' is exist and readable by khulnasoft".format(path=self.dhcpd_leases.path))
            return False
