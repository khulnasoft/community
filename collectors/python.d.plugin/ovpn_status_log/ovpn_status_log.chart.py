# -*- coding: utf-8 -*-
# Description: openvpn status log khulnasoft python.d module
# Author: ilyam8
...
class Service(SimpleService):
    ...
    def check(self):
        ...
        if not data:
            self.error('Make sure that the openvpn status log file exists and khulnasoft has permission to read it')
            return None
