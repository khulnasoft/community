# -*- coding: utf-8 -*-
# Description: disk quota khulnasoft python.d module
# Author: je2555
...
# You must give the khulnasoft user root permission for the configured command
# for this plugin to work.
# It is also recommended that you disable logging of allowed sudo privilege
# escalations for the khulnasoft user to avoid excessive repeated log entries.
